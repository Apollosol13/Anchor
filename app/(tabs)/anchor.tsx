    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.logoContainer}>
          <Ionicons name="boat-outline" size={80} color="#ffffff" />
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Share beautiful Bible verses with stunning imagery. Multiple Bible
            versions, AI-powered explanations, and a beautiful interface to help
            you engage with God's Word daily.
          </Text>
        </View>
